...
if (score < 30) {
    document.querySelector('.bottom-fire').disabled = true
} else if (score >= 30) {
    document.querySelector('.bottom-fire').disabled = false
}
if (score < 500) {
    document.querySelector('.bottom-water').disabled = true
} else if (score >= 500) {
    document.querySelector('.bottom-water').disabled = false
}
if (score < 1000) {
    document.querySelector('.bottom-frost').disabled = true
} else if (score >= 1000) {
    document.querySelector('.bottom-frost').disabled = false
}
if (score < 10000) {
    document.querySelector('.bottom-rainbow').disabled = true
} else if (score >= 10000) {
    document.querySelector('.bottom-rainbow').disabled = false
}
function fire() {
